...
export const WEAPONS = {
  ak47: {
    ...
    model: 'ak', vmPos: [0.28, -0.26, -0.55], vmRot: [0, Math.PI, 0], vmScale: 0.85,
  },
  pistol: {
    ...
    model: 'pistol', vmPos: [0.26, -0.27, -0.5], vmRot: [0, Math.PI, 0], vmScale: 0.45,
  },
  awp: {
    ...
    model: 'sniper', vmPos: [0.28, -0.28, -0.62], vmRot: [0, Math.PI, 0], vmScale: 1.1,
  },
  knife: {
    ...
    model: 'knife', vmPos: [0.3, -0.3, -0.45], vmRot: [0.2, Math.PI * 0.92, 0.15], vmScale: 0.5,
  },
};
